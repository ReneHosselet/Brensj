...
export declare function prepareArray(accessor: Accessor, encoder: typeof MeshoptEncoder, mode: MeshoptMode, filter: MeshoptFilter): ({
    array: TypedArray;
    byteStride: number;
});
...
export declare function getMeshoptFilter(accessor: Accessor, doc: Document): MeshoptFilter;
